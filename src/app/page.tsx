...
export default function Home() {
  ...
  return (
    <div className="w-full h-[100dvh] flex flex-col md:flex-row relative bg-slate-950 overflow-hidden">
      ...
      {/* 지도 컨트롤 (확대/축소/내위치) */}
      <div className="absolute z-20 top-[180px] right-4 md:top-6 md:bottom-auto md:right-auto md:left-[424px] flex flex-col gap-2 shadow-[0_5px_15px_rgba(0,0,0,0.3)]">
        <button 
